...
import { getPeopleFetch } from "../../../store/public/action";
import baseUrls from "../../../utils/base-urls";

const RePagination = (props) => {
...
const PaginationUsed = () => {
  ...
  const afterPageClicked = (page_number) => {
    ...
    dispatch(
      getPeopleFetch([
        `${baseUrls.baseApi}person/popular?api_key=${baseUrls.apiKey}&language=en-US&page=${currPage}`,
      ])
    );
  };
